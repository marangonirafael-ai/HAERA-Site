  ...
  return (
    <footer style={{ backgroundColor: BRAND.WINE_NIGHT }} className="pt-20 pb-10 px-6 md:px-10">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          <div>
            ...
            <p className="font-sans text-xs leading-relaxed" style={{ color: BRAND.CREAM, opacity: 0.55 }}>
              Suplementação clean label premium.<br />Nutrir antes de estimular.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/pulse-produto" className="font-sans text-sm transition-opacity hover:opacity-100" style={{ color: BRAND.CREAM, opacity: 0.7 }}>Pulse 150g</Link></li>
              <li><Link to="/ciencia" className="font-sans text-sm transition-opacity hover:opacity-100" style={{ color: BRAND.CREAM, opacity: 0.7 }}>Ciência</Link></li>
              ...
              <li><Link to="/trocas-devolucoes" className="font-sans text-sm transition-opacity hover:opacity-100" style={{ color: BRAND.CREAM, opacity: 0.7 }}>Trocas e Devoluções</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="font-sans text-xs tracking-[0.3em] uppercase mb-5" style={{ color: BRAND.GOLD }}>Contato</h4>
            <a
        ...
        <div className="pt-8 border-t flex flex-col md:flex-row justify-between gap-4" style={{ borderColor: `${BRAND.GOLD}25` }}>
