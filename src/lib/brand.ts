...
// Durante o teste de integrações, os CTAs de compra abrem o checkout da Yampi.
// A Lista VIP continua disponível separadamente na navegação para validar o Brevo.
